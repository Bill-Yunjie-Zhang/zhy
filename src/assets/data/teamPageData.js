...
const teamPageData = {
    students: [{
        name: "HengYi Zhang",
        txt: "Hi! I’m Zoe ( HengYi Zhang) 💗 As a thrill-seeker，I love trying everything challenging (if it is safe）and then explore my interests widely. It is difficult for me to define what I like to do or what I can do. I always believe life cannot be defined. Push limits and achieve something incredible！As for me, the ideal life has no constraints and I’m free to read novels, listen to music(especially jazz😊), playing guitar and cycling whenever I want.",
        role: "CHIEF TEAM LEADER",
        img: Zoe
    }, {
        name: "Tough Zha",
        txt: "I am Tough Zha, a senior high in Hangzhou No.14 high school AP center. I am the leader of the “dry” team of ASTWS-china, who take charge of human practices, media marketing and activity planning. The keen interest of biology brings me into IGEM and my wonderful team. I hope to embrace the adventure in IGEM and gain practical experience through this contest.",
        role: "DRY TEAM LEADER",
        img: guitar
    }, {
        name: "Cheryl",
        txt: "Hi everyone! I’m Cheryl from the changsha city. Since my city’s spirit represents being gutsy, I believe I can be brave enough to face all the challenges with my team. If anyone is in troubles, especially some emotional problems, I will be glad to help. Because I love psychology , I want to apply my knowledge for assisting more people, which is also the encouragement for me to participate the Igem.",
        role: "WET TEAM LEADER",
        img: gouZei
    }, {
        name: "Jinyan Wang",
        txt: "Hi, everyone. I’m Peter, and my Chinese name is Jinyan Wang. Xi’an is my hometown and I am 17years old this year. I would like to call myself a questioner because I want to figure out all the things I want to know in the world. Reading and doing experiment is best mean I know to get to the goal. Besides that, I like playing badminton, playing board game and watching films. Detective novels are my favorite, since I love the process of finding the answer by myself.Among all the subjects, biology is the most intriguing one. Thus, I joined Igem and met all my wonderful teammates. I hope we can have a unforgettable experience all all together.",
        role: "TEAM MEMBER",
        img: wjy
    }, {
        name: "Junran Zhao",
    ...
    supervisors: [{
        ...
        name: "Ji Wu",
        txt: "Hi, I’m Ji Wu, a Senior 1 student from Zhejiang Hangzhou High School. In my daily life, I have many hobbies. On weekdays, I often read books especi",
        img: wuji
    }, {
        name: "Junran Zhao",
        ...
        name: "Yunfei Kan",
        txt: "Greeting and is nudent. Cooking is surely my thing audent. Cooking is surely my thing aore friends, academic and casual. Wish y’all a nice day!.",
        role: "TEAM MEMBER",
        img: kanyunfei
    }]
}
